...
private:
	...
	static Sprite parseSprite(std::vector<std::string> lines, Size& size, CollisionMask& collisionMask);
...
public:
	...
	static Sprite loadSpriteFromFile(std::string path, Size& size, CollisionMask& collisionMask);
